...
/*                data: {
    ...
    W.VoterApp.getMarkers = function() {
        console.log(Markers)
    };

    W.VoterApp.getShapes = function() {
        console.log('Shapes', Shapes, 'VoterShapes', VoterShapes, 'CustomShapes', CustomShapes)
    };

    W.VoterApp.getData = function() {
        console.log('AllIndexes', AllIndexes, 'LastAddressComplete', LastAddressComplete, 'AddressData', AddressData, 'mayorAddress', mayorAddress, 'wardDivision', wardDivision)
    };

    W.VoterApp.grouper = function() {
        console.log(GrouperContext);
        //        grouper();
    }
    W.VoterApp.clearMarkers = clearMarkers;
    W.VoterApp.clearShapes = clearShapes;
}))